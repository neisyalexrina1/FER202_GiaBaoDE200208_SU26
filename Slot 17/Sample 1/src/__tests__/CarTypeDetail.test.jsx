...
const cars = [
  { id: '1', name: 'Car 101', carTypeId: 1, brand: 'Toyota', transmission: 'Automatic', priceWeekday: 800000, priceWeekend: 1200000, lastServiced: '15/03/2022' },
  { id: '4', name: 'Car 102', carTypeId: 1, brand: 'Toyota', transmission: 'Manual', priceWeekday: 800000, priceWeekend: 1200000, lastServiced: '15/03/2022' },
  { id: '2', name: 'Car 201', carTypeId: 2, brand: 'Honda', transmission: 'Manual', priceWeekday: 1500000, priceWeekend: 2000000, lastServiced: '20/06/2023' },
]
...
describe('TODO-10A: CarTypeDetail — Promise.all fetch + filter', () => {
  beforeEach(() => {
    carApi.fetchCarTypes.mockResolvedValue(carTypes)
    carApi.fetchCars.mockResolvedValue(cars)
  })

  test('hiển thị tên loại xe', async () => {
    renderDetail('1')
    await waitFor(() => {
  ...
  test('chỉ hiển thị xe thuộc loại Economy (carTypeId=1)', async () => {
    renderDetail('1')
    await waitFor(() => screen.getByText('Economy'))
