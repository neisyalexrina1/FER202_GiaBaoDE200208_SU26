...
const mockCar = {
  id: '1', name: 'Car 101', carTypeId: 1, brand: 'Toyota',
  transmission: 'Automatic', priceWeekday: 800000, priceWeekend: 1200000, lastServiced: '15/03/2022'
}

const mockCtx = {
  state: { carTypes: [{ id: 1, name: 'Economy' }], cars: [], loading: false, error: null },
  dispatch: jest.fn(),
}
...
describe('TODO-05: CarDetail — fetch và hiển thị thông tin xe', () => {
  test('hiển thị tên xe sau khi load', async () => {
